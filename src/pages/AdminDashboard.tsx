...
import { Package, Users, DollarSign, TrendingUp, RefreshCw, Plus, Edit, Trash, LayoutDashboard, Tag, ShoppingBag, BarChart3, CheckCircle } from 'lucide-react';
import { db } from '../lib/firebase';
import { collection, getDocs, doc, setDoc, updateDoc, deleteDoc } from 'firebase/firestore';

export default function AdminDashboard() {
  const { user, isAdmin } = useAuthStore();
  const [activeTab, setActiveTab] = useState<'overview' | 'products' | 'orders' | 'vouchers' | 'reports'>('overview');
